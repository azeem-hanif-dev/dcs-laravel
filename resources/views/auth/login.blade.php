...
@section('content')
<div class="flex h-screen overflow-hidden bg-[#0b1a2e]" x-data="{
    ...
    {{-- Left Side - Form --}}
    <div class="w-full lg:w-1/2 bg-[#0f2744] flex flex-col h-full">
        <div class="flex-1 flex items-center justify-center">
            <div class="max-w-md w-full p-8 rounded-xl bg-[#153359] shadow-lg">
                <div class="flex justify-center mb-6">
                    <img src="/common/distributor-logo.svg" alt="Distributor Logo" class="h-16 w-auto" />
                </div>
                    ...
                    <form @submit.prevent="async () => {
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" x-model="companyName" required
                                class="w-full px-3 bg-[#0f2744] text-white py-3 border border-[#2EA8FA]/30 rounded-md focus:outline-none focus:ring-2 focus:ring-[#2EA8FA] focus:border-transparent"
                ...
                <div x-show="step === 2" x-transition>
                    <div class="flex items-center mb-4">
                        <button @click="step = 1; errorMsg = ''" class="text-gray-400 hover:text-white mr-3 p-1 rounded-md hover:bg-[#0f2744]">
                    ...
                    <form @submit.prevent="async () => {
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative">
                                ...
                                <button type="button" @click="showPassword = !showPassword" class="absolute right-2 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-200">
    ...
    {{-- Right Side - Image --}}
    <div class="hidden lg:flex lg:w-1/2 items-center justify-center bg-gradient-to-br from-[#0b1a2e] via-[#0f2744] to-[#153359]">
        <img src="/common/distributor-logo.svg" alt="Distributor" class="w-64 opacity-20" />
    </div>

    {{-- Forgot Password Modal --}}
    <div x-show="modalOpen" class="fixed inset-0 z-50 flex items-center justify-center bg-black/50" x-transition @click.outside="modalOpen = false">
        <div class="bg-white rounded-xl shadow-xl p-6 w-[90%] max-w-md">
            ...
            <form @submit.prevent="async () => {
                ...
                <div class="flex gap-3">
                    <button type="button" @click="modalOpen = false" class="flex-1 px-4 py-2 bg-gray-200 rounded-md hover:bg-gray-300">Cancel</button>
                    <button type="submit" :disabled="loading" class="flex-1 px-4 py-2 bg-primary text-white rounded-md hover:bg-primary-dark">Send Reset Link</button>
                </div>
