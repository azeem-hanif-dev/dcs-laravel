...
function quotationData(){return{
    ...
    async init(){try{this.pager=Alpine.store('pager').create({endpoint:'/api/v1/qoutation',perPage:10})}catch(e){console.error('Pager create failed:',e);this.pager.loading=false;return}this.pager.fetchPage()},
