        ...
        <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-md z-10" @click.outside="closeModal()">
            ...
            <form @submit.prevent="saveItem()" class="p-6 space-y-4">
                <div>
                    ...
                    <input type="text" x-model="form.name" placeholder="Enter category name" class="w-full border border-gray-300 rounded-xl px-3 py-2.5 text-sm focus:ring-2 focus:ring-primary/30 focus:border-primary outline-none">
