...
function distributorData(){return{
    ...
    async fetchSuppliers(){try{let d=await $store.api.get('/api/v1/supplier',{per_page:500});if(d&&d.status)this.suppliers=d.data?.data||d.data||[]}catch(e){console.error('Failed to load suppliers:',e)}},
    async init(){await this.fetchSuppliers();this.fetchItems()},
