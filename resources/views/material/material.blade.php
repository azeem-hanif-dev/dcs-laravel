...
function materialData(){return{
    ...
    async fetchCategories(){try{var d=await $store.api.get('/api/v1/category',{per_page:200});this.categories=d.data?.data||d.data||[]}catch(e){console.error(e)}},
    async fetchSubcategories(){if(!this.form.categoryId){this.subcategories=[];return};try{var d=await $store.api.get('/api/v1/subcategory',{categoryId:this.form.categoryId,per_page:200});this.subcategories=d.data?.data||d.data||[]}catch(e){console.error(e)}},
    async fetchSuppliers(){try{var d=await $store.api.get('/api/v1/supplier',{per_page:200});this.suppliers=d.data?.data||d.data||[]}catch(e){console.error(e)}},
