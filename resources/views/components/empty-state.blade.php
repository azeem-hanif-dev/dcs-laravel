{{-- Professional "No Records Found" empty state for tables --}}
@props(['colspan' => '7', 'icon' => 'default', 'title' => 'No records found', 'message' => ''])
...
<tr>
    <td colspan="{{ $colspan }}" class="px-6 py-20 text-center">
        <div class="max-w-sm mx-auto">
            ...
            <h3 class="text-base font-semibold text-gray-400 mb-1">{{ $title }}</h3>
            @if($message)
